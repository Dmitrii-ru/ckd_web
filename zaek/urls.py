...
from zaek.utils.parser_price.preparing_data_for_loading_into import preparing_data_loading_into
...
urlpatterns = [
    ...
    path('dmp/preparing_data_loading_into', func_preparing_data_for_loading_into , name='preparing_data_loading_into'),
